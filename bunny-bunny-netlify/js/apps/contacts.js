...
function profileSeed(p,avatar){return{avatarUrl:avatar,remark:p.name,voiceSpeed:1,voiceId:"",autoPlayVoice:false,llmTone:true,language:"中文",emotion:"自动",toneStyle:"自然",translationEnabled:false,visionEnabled:true,memoryDepth:24,quietHours:"23:00—08:00",proactiveCall:false,patText:`你拍了拍${p.name}`,patUserText:`${p.name}拍了拍你`}}
