...
export function navigate(name, params = {}, options = {}) {
  ...
  back.onclick = () => {
    ...
    else if (["character-edit", "user-profile"].includes(name)) navigate("contacts");
    else if (name === "add-friend") navigate("chat");
