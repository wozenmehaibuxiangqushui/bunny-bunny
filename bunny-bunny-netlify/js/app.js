...
placeholderRoutes.filter(route => !["worldbook","presets","wallet","x-social","tiktok"].includes(route)).forEach(route => registerRoute(route, createPlaceholderRenderer(route)));
