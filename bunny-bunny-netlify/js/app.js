...
import { createContactsRenderer, createContactManagerRenderer, createCharacterEditorRenderer, createUserProfileRenderer, createAddFriendRenderer } from "./apps/contacts.js";
...
import { hydrateMediaState } from "./media-store.js";
import { createFavoritesRenderer } from "./favorites.js";
import { setupProactiveMessages } from "./proactive-messages.js";
import { createMemoryDebugRenderer } from "./memory-debug.js";
import { createAnonymousBoxRenderer, createAnonymousLetterRenderer, setupAnonymousQuestions } from "./anonymous-box.js";
...
registerRoute("relationship-map", createRelationshipNotebookRenderer(context));
...
registerRoute("moments", createMomentsRenderer(context));
registerRoute("chat-me", chats.me);
registerRoute("favorites", createFavoritesRenderer(context));
registerRoute("memory-debug", createMemoryDebugRenderer(context));
registerRoute("anonymous-box", createAnonymousBoxRenderer(context));
...
placeholderRoutes.filter(route => !["worldbook","presets","wallet","x-social","tiktok","forum"].includes(route)).forEach(route => registerRoute(route, createPlaceholderRenderer(route)));
