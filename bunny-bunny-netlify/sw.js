const CACHE_NAME = "bunny-bunny-shell-v6";
...
const APP_SHELL = [
  ...
  "./css/tokens.css", "./css/enhancements.css", "./css/splash.css", "./css/shell.css", "./css/components.css", "./css/apps/desktop.css", "./css/apps/chat.css", "./css/apps/settings.css", "./css/apps/social.css", "./css/responsive.css", "./css/ios-refinement.css", "./css/chat-v3.css", "./css/call-v3.css",
  "./js/app.js", "./js/chat-v3.js", "./js/wallet-v2.js", "./js/voice-client.js", "./js/call-prompts.js", "./js/call-v3.js", "./js/ios-refinement.js", "./js/splash.js", "./js/pwa.js", "./js/webmcp.js", "./js/core/store.js", "./js/core/router.js", "./js/core/ui.js",
