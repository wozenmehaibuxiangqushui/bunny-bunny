const CACHE_NAME = "bunny-bunny-shell-v53";
...
const APP_SHELL = [
 ...
 "./js/forum-model.js", "./js/forum-engine.js", "./js/forum-app.js", "./css/forum-app.css", "./css/fullscreen-shell.css", "./css/group-chat-plus.css",
 "./js/world-context.js",
